...
interface CursorRuleFiltersProps {
...
export function CursorRuleFilters({ onFiltersChange, initialFilters }: CursorRuleFiltersProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Search cursor rules..."
      ...
      <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
        ...
        <Tabs value={filters.type} onValueChange={(value) => updateFilter('type', value)} className="w-full lg:w-auto">
          <TabsList className="grid w-full lg:w-auto grid-cols-5 lg:grid-cols-5">
            <TabsTrigger value="all" className="cursor-pointer">All Rules</TabsTrigger>
            <TabsTrigger value="always" className="cursor-pointer">Always</TabsTrigger>
            <TabsTrigger value="auto-attached" className="cursor-pointer">Auto</TabsTrigger>
            <TabsTrigger value="agent-requested" className="cursor-pointer">Agent</TabsTrigger>
